...
public class AccountManager {
    ...
    public void credit_balance(long acc_no)throws  SQLException
    {
        scanner.nextLine();
        ...
        String mpin=scanner.next();
        String query="SELECT * FROM Accounts WHERE acc_no = ? and mpin = ? ;";
        try{
    ...
    public void debit_money(long acc_no) throws SQLException {
        ...
        try {
            connection.setAutoCommit(false);
            if(acc_no!=0) {
                PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM Accounts WHERE acc_no = ? and mpin = ? ");
                preparedStatement.setLong(1, acc_no);
                preparedStatement.setString(2,mpin);
                ResultSet resultSet = preparedStatement.executeQuery();
    ...
    public void get_balance(long acc_no)
    {
        ...
        String mpin=scanner.nextLine();
        String query="select balance from Accounts where acc_no=? and mpin=?;";
